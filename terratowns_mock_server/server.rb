...
class Home
  ...
  # It is used as an ORM. It has a module within AcobeModel that
  # provides validations. The production TerraTowns server is Rails
  ...
  # Town names from: https://terratowns.cloud/
  ...
  # We want to lock this down to ony be from CloudFront.
  validates :domain_name, 
    format: { with: /\.cloudfront\.net\z/, message: "domain must be from .cloudfront.net" }
    # uniqueness: true, 

  # content_version has to be an integer.
  # We will make usre it's an incremental version in the controller.
...
class TerraTownsMockServer < Sinatra::Base
  ...
  post '/api/u/:user_uuid/homes' do
    ...
    # puts will print to the terminal similiar to a print or console.log.
    ...
    # Assign the payload to variables to make it easier to work
    # with the code.
    name = payload["name"]
    ...
    # to see or debug what we have input into this endpoint.
    puts "name #{name}"
    ...
    # Ensure our validations checks pass for Home, otherwise
    # return the errors.
    unless home.valid?
